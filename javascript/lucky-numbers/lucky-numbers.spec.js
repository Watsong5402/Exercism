import { twoSum, luckyNumber, errorMessage, arrayToNumber } from "./lucky-numbers";
...
describe("arrayToNumber", () => {
  test("changes n length array into proper number", () => {
    expect(arrayToNumber([1, 2, 3, 4])).toBe(1234);
    expect(arrayToNumber([1, 2, 3])).toBe(123);
  });
});
